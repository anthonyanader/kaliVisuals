...
class Dashboard extends Component {
  ...
  displayAddedTime = tag =>
    tag ? `Added ${this.timeFromNow(tag.monitorStartDate)}` : '';

  render() {
    const { currentTag, chartData } = this.state;
    ...
    return (
      <React.Fragment>
        ...
        <DashboardOptions currentTag={currentTag} />
      </React.Fragment>
    );
  }
}
